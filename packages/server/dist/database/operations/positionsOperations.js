...
export const getPositionsForSet = async (positionSetId) => {
    ...
    return result.rows.map(mapRowToRawPosition);
};
export const getPositionsForActiveSet = async () => {
