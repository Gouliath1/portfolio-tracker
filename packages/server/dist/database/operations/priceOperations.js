 ...
 */
export const getHistoricalPricesForSymbol = async (symbol) => {
 ...
 */
export const getTodaysPrice = async (symbol) => {
 ...
 */
export const storePriceData = async (symbol, date, price) => {
    const client = getDbClient();
    try {
 ...
 */
export const storeHistoricalPrices = async (symbol, prices) => {
    const client = getDbClient();
    try {
 ...
 */
export const getAllHistoricalPrices = async () => {
    const client = getDbClient();
    try {
