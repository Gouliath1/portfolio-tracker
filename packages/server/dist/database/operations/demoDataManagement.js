...
const resolveBrokerInfo = (brokerName) => {
    if (!brokerName) {
...
const ensureBroker = async (client, brokerName) => {
    ...
    if (existing.rows.length > 0) {
        return {
            ...
            info: Object.assign(Object.assign({}, baseInfo), { display: String(existing.rows[0].display_name || baseInfo.display) })
        };
    }
    const displayName = (brokerName === null || brokerName === void 0 ? void 0 : brokerName.trim()) || baseInfo.display;
    ...
    return {
        ...
        info: Object.assign(Object.assign({}, baseInfo), { display: displayName, currency })
    };
};
const DEFAULT_DEMO_POSITIONS = [
    {
 ...
 */
export const initializeDemoPositions = async () => {
    var _a;
    console.log('📋 Loading built-in demo positions...');
    try {
        const positions = DEFAULT_DEMO_POSITIONS;
        ...
        for (const position of positions) {
            try {
                ...
                const accountName = ((_a = position.account) === null || _a === void 0 ? void 0 : _a.trim()) || 'General';
